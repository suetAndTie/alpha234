...
class Connect4NNet(nn.Module):
    def __init__(self, game, num_channels=512, dropout=0.3):
        super().__init__()
...
class Connect4ResNet(nn.Module):
    ...
    def __init__(self, game, block=BasicBlock, layers=[3,4,6,3], zero_init_residual=False):
        super().__init__()
        ...
        self.fc_pi = nn.Linear(512 * block.expansion, self.action_size)
