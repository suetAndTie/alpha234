"""
Adapted from
https://github.com/AppliedDataSciencePartners/DeepReinforcementLearning/blob/master/games/connect4/game.py
"""
...
class Game:
    def __init__(self):
        ...
        self.gameState = GameState(np.zeros(42, dtype=np.int), 1)
